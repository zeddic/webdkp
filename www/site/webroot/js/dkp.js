...
DKP = new (function() {
	...
	this.ColorSelectedRow = function(checkbox){
	// Will color the rows selected . . . to be added
...
var ServerTable = Class.create(DKPTable, {
	...
	GetRow: function(i) {
		...
		row.appendChild(Builder.node('td',{className:"center"},this.items[i].total));
...
var GuildsTable = Class.create(DKPTable, {
	GetRow: function(i) {
		...
		row.appendChild(Builder.node('td',{className:"center"},this.items[i].faction));
