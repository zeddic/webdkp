...
class dkpPointsHistoryTableEntryOld {
	...
	const tablename = "dkp_pointhistory_old";
	...
	function dkpPointsHistoryTableEntryOld()

	{

		$this->tablename = dkpPointsHistoryTableEntryOld::tablename;
...

	{
		...
		$tablename = dkpPointsHistoryTableEntryOld::tablename;
...

	{
		...
		if(!sql::TableExists(dkpPointsHistoryTableEntryOld::tablename)) {
...
dkpPointsHistoryTableEntryOld::setupTable();
