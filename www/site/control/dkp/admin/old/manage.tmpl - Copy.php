...
<input type="button" class="mediumButton" id="AwardButton" onclick="DKPManage.StartAward()" value="Create Award">

<div id="AwardContent1" style="display:none">
<table class="dkpForm" >
<tr>
...
<tr>
	<td>
	<input type="button" class="largeButton" onclick="DKPManage.Cancel()" value="Cancel" style="width:100px">
...
<tr>
	<td>
	<table class="dkp" id="playertable" cellpadding=0 cellspacing=0 >
		<thead>
		<tr class="header">
...
<tr>
	<td>
	<input type="button" class="largeButton" onclick="DKPManage.Finish()" value="Continue" style="width:100px">
	</td>
</tr>
</table>
</div>
...
<table class="dkpForm" >
<tr>
	<td><div class="dkpSubtitle" id="altsTitle"></div></td>
</tr>
<tr>
	<td>
		Here you can set the any alts for this character. Alts, short for "alternative
		characters" represent other characters played by the same person. If you
		have the 'Alt & Main DKP Sharing' option enabled, this information will be
		used when transfering DKP.
		<br />
		<br />
		<input type="button" class="largeButton" onclick="DKPManage.HideAlts()" value="Back" style="width:100px">
	</td>
</tr>
<tr>
	<td>
	<table class="dkp" id="alttable" cellpadding=0 cellspacing=0 >
		<thead>
		<tr class="header">
			<th class="link"><a>Alts</a></th>
...
<table class="dkp" id="manageTable" cellpadding=0 cellspacing=0 >
	<thead>
	<tr class="header">
		<th class="link"><a>Player</a></th>
		<th class="link center" style="width:150px"><a>Guild</a></th>
		<th class="link center" style="width:100px"><a>Class</a></th>
...
table.SetDetails("<?=$guild->name?>", <?=$canDelete?>, <?=$canEditPlayer?>, <?=$canAddPlayer?>, <?=$canAddPoints?>);
