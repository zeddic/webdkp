...
WebDKP = new (function() {
	...
	this.SetupTable = function() {
		...
		var table = Builder.node('table',{className:"dkp",cellpadding:0,cellspacing:0,id:"webdkptable"});
		var thead = Builder.node('thead');
		var header = Builder.node('tr',{className:"header"});
		header.appendChild(Builder.node('th',{className:"link"}, Builder.node('a',{},"name")));
		header.appendChild(Builder.node('th',{className:"link",style:"width:100px"}, Builder.node('a',{},"class")));
		header.appendChild(Builder.node('th',{className:"link",style:"width:100px"}, Builder.node('a',{},"dkp")));
		header.appendChild(Builder.node('th',{className:"link",style:"width:100px"}, Builder.node('a',{},"lifetime")));
