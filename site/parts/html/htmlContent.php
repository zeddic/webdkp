...
class htmlContent {
	...
	var $lastupdateTime;
	var $content;
	const tablename = "part_html";
	/*===========================================================
	DEFAULT CONSTRUCTOR
	============================================================*/
	function htmlContent()
	{
		$this->tablename = htmlContent::tablename;
	}
	/*===========================================================
	loadFromDatabase($id)
	...
	function exists($name)
	{
		...
		$tablename = htmlContent::tablename;
	...
	function setupTable()
	{
		if(!sql::TableExists(htmlContent::tablename)) {
			$tablename = htmlContent::tablename;
			global $sql;
